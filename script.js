function DisplayCurrentTime() {
  ...
  document.getElementById("a-hour").innerHTML = hours + "<br>Hours";
  document.getElementById("a-minutes").innerHTML = minutes + "<br>mins";
  document.getElementById("a-second").innerHTML = seconds + "<br>secs";
  document.getElementById("a-am-pm").innerHTML = am_pm;
}
...
function displayValue() {
  ...
  if (waketime == "none") {
    ...
    document.getElementById("wake_up").innerHTML = "Wake up time : " + invalue1;
  }

  if (lunchtime == "none") {
    document.getElementById("lunch").innerHTML = "";
  } else {
    document.getElementById("lunch").innerHTML = "Lunch time : " + invalue2;
  }
